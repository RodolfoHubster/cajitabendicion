-- ============================================================
--  Cajita de Bendicion - El tope por telefono se cuenta por dia
--
--  Antes: un registro por telefono POR SEMANA. Como el lunes y el jueves
--  caen en la misma semana, quien apartaba el lunes ya no podia apartar
--  el jueves desde ese mismo telefono.
--
--  Ahora: se cuenta POR FECHA DE ENTREGA. Cada entrega es su propio
--  evento. Con el tope en 1, el mismo telefono aparta el lunes y tambien
--  el jueves, pero nunca dos veces el mismo dia.
--
--  Para volver a una sola cita por semana no se toca esto: eso se decide
--  reconociendo a la persona, no al telefono.
--
--  Solo cambia registrar_y_reservar(). Se puede repetir.
-- ============================================================

update configuracion
   set nota = 'Cuantas citas puede crear un mismo telefono POR FECHA DE ' ||
              'ENTREGA. Con 1, el mismo telefono aparta el lunes y tambien ' ||
              'el jueves, pero no dos veces el mismo dia. Es un tope, no un ' ||
              'muro: una ventana privada o borrar datos del navegador cuenta ' ||
              'como dispositivo nuevo. Se sube cuando llega una familia que ' ||
              'comparte un solo telefono.'
