...
| `2026-09-23-avisos-editables.sql` | Tabla `avisos`: lo que la gente lee en la portada y las reglas que acepta antes de sacar su QR, editables desde **Textos y reglas** en el panel. Trae las reglas de arranque |
| `2026-09-23-borrar-fecha-con-sus-horarios.sql` | Al eliminar una fecha, `eliminar_dia_entrega()` ahora borra también sus horarios. Antes quedaban huérfanos y reaparecían si se volvía a crear esa fecha |
